...
path_df = os.path.join(root, 'recons_dataset/dataset10.csv')
data = pd.read_csv(path_df)

scaler = MinMaxScaler()
train, test = train_test_split(data, test_size=0.10)

X_train = train.drop('Q28', axis=1)
Y_train = train['Q28']

X_test = test.drop('Q28', axis=1)
Y_test = test['Q28']
...
model_path = os.path.join(root, 'models/rfc10.sav')
joblib.dump(clf10, model_path)

# Saving the scaler object
scaler_path = os.path.join(root, 'models/scaler10.pkl')
