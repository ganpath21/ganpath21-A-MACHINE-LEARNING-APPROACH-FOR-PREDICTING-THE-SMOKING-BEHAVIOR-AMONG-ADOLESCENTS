...
path_df = os.path.join(root, 'recons_dataset/dataset11.csv')
data = pd.read_csv(path_df)

scaler = MinMaxScaler()
train, test = train_test_split(data, test_size=0.10)

X_train = train.drop('Q39', axis=1)
Y_train = train['Q39']

X_test = test.drop('Q39', axis=1)
Y_test = test['Q39']
...
model_path = os.path.join(root, 'models/rfc11.sav')
joblib.dump(clf11, model_path)

# Saving the scaler object
scaler_path = os.path.join(root, 'models/scaler11.pkl')
