...
path_df = os.path.join(root, 'recons_dataset/dataset9.csv')
data = pd.read_csv(path_df)

scaler = MinMaxScaler()
train, test = train_test_split(data, test_size=0.10)

X_train = train.drop('Q24', axis=1)
Y_train = train['Q24']

X_test = test.drop('Q24', axis=1)
Y_test = test['Q24']
...
model_path = os.path.join(root, 'models/rfc9.sav')
joblib.dump(clf9, model_path)

# Saving the scaler object
scaler_path = os.path.join(root, 'models/scaler9.pkl')
