...
path_df = os.path.join(root, 'recons_dataset/dataset8.csv')
data = pd.read_csv(path_df)

scaler = MinMaxScaler()
train, test = train_test_split(data, test_size=0.10)

X_train = train.drop('Q23', axis=1)
Y_train = train['Q23']

X_test = test.drop('Q23', axis=1)
Y_test = test['Q23']
...
model_path = os.path.join(root, 'models/rfc8.sav')
joblib.dump(clf8, model_path)

# Saving the scaler object
scaler_path = os.path.join(root, 'models/scaler8.pkl')
